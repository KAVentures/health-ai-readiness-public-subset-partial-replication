...
# Examples:
#     python test_runner_async.py VQA-RAD gpt-4o t0 vqa zero
#     python test_runner_async.py VQA-RAD o3 t1 vqa high
#     python test_runner_async.py VQA-RAD deepseek t0 vqa zero
#     python test_runner_async.py VQA-RAD gemini-2.0-flash t0 vqa zero
#     python test_runner_async.py VQA-RAD claude-sonnet-3.5 t0 vqa zero
#     python test_runner_async.py VQA-RAD gpt-4o t0 text zero
