...
# Examples:
#     python test_runner_async.py PMC-VQA gpt-4o t0 vqa zero
#     python test_runner_async.py PMC-VQA o3 t1 vqa high
#     python test_runner_async.py PMC-VQA deepseek t0 vqa zero
#     python test_runner_async.py PMC-VQA gemini-2.0-flash t0 vqa zero
#     python test_runner_async.py PMC-VQA claude-sonnet-3.5 t0 vqa zero
#     python test_runner_async.py PMC-VQA gpt-4o t0 text zero

# Async test script for PMC-VQA dataset
